    ...
    >
      ...
      <div className="relative w-full flex items-center justify-center">
        <select
          ...
          className={`appearance-none flex items-center justify-center w-full h-[40px] max-md:text-[12px] px-2 pr-6 border border-[#AAAAAA] outline-none rounded-lg ${className}`}
        >
          {optionsHolder && (
            <option
              value={""}
